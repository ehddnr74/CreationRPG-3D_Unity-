...
public class QuestManager : MonoBehaviour
{
    ...
    public void ShowQuestInfo(Quest quest)
    {
        ...
        foreach (var slot in rewardSlots)
        {
            ...
            //QuestRewardDT questRewardData = slot.GetComponent<QuestRewardDT>();
            //questRewardData.item = null;
            //questRewardData.amount = 0;
        }
        ...
        for (int i = 0; i < quest.reward.items.Count; i++)
        {
            ...
            //QuestRewardDT questRewardData = rewardSlots[i].GetComponent<QuestRewardDT>();
            //questRewardData.item = item;
            //questRewardData.amount = quest.reward.items[i].amount;
        }
